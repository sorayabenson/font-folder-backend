...
// a test version for static url
app.get('/fontstest', async(req, res) => {
  try {
    const fontData = await request.get(`https://www.googleapis.com/webfonts/v1/webfonts?sort=style&key=${process.env.GOOGLE_FONT_KEY}`);
